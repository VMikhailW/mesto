...
export const btnSubmitDelSelector = `${popupSelectors.confirm} ${popupForm.submitBtnSelector}`;
export const btnSubmitDel = document.querySelector(btnSubmitDelSelector);
